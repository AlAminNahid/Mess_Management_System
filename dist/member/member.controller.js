...
let MemberController = class MemberController {
    ...
    sendNotice(info, req) {
        ...
        return this.memberService.sendNotice(info.title, info.description, notice_type, userID);
    }
};
...
], MemberController.prototype, "getMemberDashboard", null);
__decorate([
...
], MemberController.prototype, "sendNotice", null);
exports.MemberController = MemberController = __decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(role_enum_1.UserRole.MEMBER),
